...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar text-neutral-content bg-opacity-66 flex h-20 flex-row border-b border-zinc-600 bg-black shadow-lg md:mb-2">
        <div className="navbar-start align-items-center">
          <div className="w-22 h-22 ml-10 hidden sm:inline md:p-2">
            <Link
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <feGaussianBlur
                      stdDeviation="9"
                      result="effect1_foregroundBlur_2066_13849"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_2066_13849"
                    x1="264.936"
                    y1="23"
                    x2="126.269"
                    y2="109.737"
        ...
        <div className="navbar-end">
          <div className="align-items-center justify-items hidden gap-6 md:inline-flex">
            <NavElement
              label="Home"
              href="/"
            ...
            <NavElement
              ...
              navigationStarts={() => setIsNavOpen(false)}
            />
            <WalletMultiButtonDynamic className="btn-ghost btn-sm rounded-btn mr-6 text-lg " />
          </div>
          <label
            htmlFor="my-drawer"
          ...
          >
            <div className="HAMBURGER-ICON ml-5 space-y-2.5">
              <div
                className={`h-0.5 w-8 bg-[#80ff7d] ${isNavOpen ? "hidden" : ""}`}
              />
              <div
                className={`h-0.5 w-8 bg-[#80ff7d] ${isNavOpen ? "hidden" : ""}`}
              />
            ...
            <div
              className={`absolute block h-0.5 w-8 animate-pulse bg-[#80ff7d] ${isNavOpen ? "" : "hidden"}`}
          ...
          <div>
            <div className="absolute right-14 block h-0.5 w-12 rotate-90 bg-zinc-600"></div>
          </div>
          <div className="dropdown dropdown-end">
            <div
              tabIndex={0}
              className="btn btn-square btn-ghost mr-4 text-right"
            >
              <svg
                className="h-7 w-7"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <ul
              tabIndex={0}
              className="menu dropdown-content bg-base-100 rounded-box p-2 shadow sm:w-52"
            >
              <li>
